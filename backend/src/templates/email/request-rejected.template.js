export const requestRejectedTemplate = ({
  name,
  requestTitle,
  stage,
  remarks,
        ...
        >
          <tr>
            <td
              ...
              "
            >
              <h1 style="margin:0;font-size:26px;">Request Denied</h1>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:40px 32px;">
              ...
              <p style="font-size:16px;line-height:1.7;color:#4b5563;">
                We regret to inform you that your request titled
                <strong>"${requestTitle}"</strong> has been denied at the
                <strong>${stage}</strong> review stage.
              </p>
              ...
              <p style="font-size:14px;line-height:1.7;color:#6b7280;">
                If you believe this decision was made in error, or if you
                would like clarification, please contact your reviewing
                officer or submit a new request addressing the concerns
                above.
              </p>
